...
class Blockchain:
    ...
    def __init__(self, public_key, node_id):
        ...
        #self.load_data() move to down becuase we're not getting a set of previous nodes which we created
    ...
    def get_peer_nodes(self):
        ...
        #return self.__peer_nodes[:] __peer_nodes is type of set -
        #so returns a set and can't be copy so convert to list
