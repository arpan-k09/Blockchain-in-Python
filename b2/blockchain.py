...
'''Printed at the time of node file is executing bcz of node importing 
this file so compiler check whole data of this file and print __name__ as this file name.'''
print(__name__)
